                        ...
                        <div class="login-form__content__body">
                            ...
                            <div class="form-control">
                                <input class="form-control__input <?php
                                                                    ...
                                                                    ?>" placeholder="Enter your Email" name="email" value="<?php
                            ...
                            <div class="login-form__content__login">
                                <input type="submit" value="Send" name="emailSubmit" class="btn primary-btn form-btn login-form__content__login" name="signup" style="background-color: #6fa8dc;">
