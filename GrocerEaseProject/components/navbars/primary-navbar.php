...
<body>
    <div class="navbar primary-navbar" style="background-color:bisque;">
        <div class="container primary-navbar__content">
            ...
            <div class="primary-navbar__content__right">
                ...
                ?>
                    ...
                    <a href="http://127.0.0.1:8080/apex/f?p=103:LOGIN_DESKTOP:17133499725631:::::" class="nav-links nav-links--desktop" target="_blank">
                        Oracle Dashboard
                    </a>
                <?php
                }
