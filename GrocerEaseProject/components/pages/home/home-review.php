...
<body>
    ...
    <div class="section home-review"  style="background-color:beige;">
                ...
                <div class="home-review__card"  style="background-color:beige;">
                    <div class="home-review__card__image">
                        <img src='assets/images/ProductImage/<?php echo $ProductToReview['PRODUCT_IMAGE']?>'/>
                    </div>
                    <div class="home-review__card__content"  style="background-color:beige;">
