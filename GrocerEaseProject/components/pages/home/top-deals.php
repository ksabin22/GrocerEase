...
<body>
    <div class="section homepage__top-deals"  style="background-color:beige;">
        ...
        <div class="section__card-body"  style="background-color:beige;">
            ...
            ?>
                <div class="product-card" style="background-color:beige;">
