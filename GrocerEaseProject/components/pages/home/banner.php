...
<body>
<div class="banner-wrapper"  style="background-color:beige;">

<div class="banner-wrapper__btn banner-wrapper__btn--next" id="nextBtn">
    <img src='assets/images/next.svg'/>
</div>

<div class="banner-wrapper__btn banner-wrapper__btn--prev" id="prevBtn">
    <img src='assets/images/prev.svg'/>
</div>


<div class="banner-wrapper__images"  style="background-color:beige;">
