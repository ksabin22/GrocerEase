...
?>
  ...
  <div class="order-history-description"  style="background-color:beige;">
            ...
            ?>
            <div class="order-history"  style="background-color:beige;">
               <div class="order-history__details"  style="background-color:beige;">
                   <table class="order-history__details__table"  style="background-color:beige;">
                       <tr>
                           <th>Order No</th>
                           <th> Status</th>
                           <th> Total</th>
