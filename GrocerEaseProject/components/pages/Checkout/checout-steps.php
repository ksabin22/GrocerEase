...
?>
">
                    <div class="checkout__body__left__step"  style="background-color:beige;">
                        <form method="POST" >
                        ...
                        <div class="checkout__body__left__step__sub checkout-select-date">
                            ...
                            <div class="checkout-body checkout-select-date__body"  style="background-color:beige;">
                    ...
                    ?>
                         ">
                            ...
                            <div class="checkout-payment-card">
                                <input type="radio" name="payment" id="paypal" required checked>
