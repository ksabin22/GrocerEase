...
<body data-theme="default" id="get-theme" style="background-color:azure;">
    ...
    <div class="page">
        ...
        <div class="container page__body" style="background-color:azure;">
            <div class="my-products" style="background-color:azure;">
                <div class="user-dashboard__content" style="background-color:azure;">

                    <div class="section__header" style="background-color:azure;">

                        <div class="section__header__heading" style="background-color:azure;">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-control" style="background-color:azure;">
                        ...
                        <div class="account-settings__user-details__others__flex" style="background-color:azure;">
                            <?php
                            if ($type == 'add') {
