                    ...
                    <div class="login-form__content" style="background-color:beige;">
                        ...
                        <div class="login-form__content__login">
                            ...
                            <div style="text-align: center; margin-top: 20px;">
                                ...
                                <input type="submit" value="Sign In As Admin" class="btn primary-btn form-btn login-form_content_login" name="adminsignin" id="adminSignInBtn">
                            </div>
...
<script>
    ...
    adminSignInBtn.addEventListener('click', function() {
        ...
        window.open('http://127.0.0.1:8080/apex/f?p=104:LOGIN_DESKTOP:15574540211720:::::', '_blank');
    });
</script>
