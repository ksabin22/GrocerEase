...
<head>
    ...
    <title><?php echo $row['PRODUCT_NAME'] . ' | GrocerEase'; ?></title>
            ...
            <div class="ProductMain">
                ...
                <div class="ProductDetail-wrapper">
                    ...
                    <div class="ProductDetail-wrapper__price">
                        &#163; <?php if ($discountPrice > 0) { ?><i><strike><?php echo $oldPrice; ?></strike></i> <?php echo ($oldPrice - $discountPrice);
                                                                                                                } else {
                                                                                                                    echo $row['PRICE'];
                                                                                                                } ?>
                    </div>
                    <div class="ProductDetail-wrapper__information">
                        ...
                        ?>
                            ...
                            <div class="ProductDetail-wrapper__information__AllegryInfo"><?php if (empty($row['ALERGYINFORMATION'])) {
                                                                                                echo "No Allergy Information Found.";
                                                                                            } else {
                                                                                                echo $row['ALERGYINFORMATION'];
                                                                                            } ?></div>
                        <?php }
                        ?>
                ...
                <div class="ProductCart-wrapper">
                    ...
                    <div class="ProductCart-wrapper__quantity__Stock Stock-Hide" <?php if (!$stockOutFlag) {
                                                                                        echo 'hidden';
                                                                                    } ?>>Out of Stock</div>
                    ...
                    <div class="ProductCart-wrapper__buttons">
                        ...
                        <form class="ProductCart-wrapper__buttons__Add-Cart" method="POST" id="review">
                            ...
                            <button class="btn primary-outline-btn card-btn" type="submit" name="add-product" <?php if ($stockOutFlag) {
                                                                                                                    echo "disabled";
                                                                                                                } ?>>Add to Cart</button>
                        </form>
                    </div>
