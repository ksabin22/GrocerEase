...
<body data-theme="default" id="get-theme"  style="background-color:beige;">
    <div class="page user-dashboard-page"  style="background-color:beige;">
        ...
        <div class="container page__body"  style="background-color:beige;">
            <div class="user-dashboard"  style="background-color:beige;">
                <?php
                $pageName = "settings";
                $isCustomer &&
                ...
                ?>
                <div class="user-dashboard__content"  style="background-color:beige;">
...
<div id="resetPasswordSection" class="account-settings__reset hidden"  style="background-color:beige;">
    <div class="section__header">
        <div class="section__header__heading-1">
           You can change your password from here 
        </div>
    </div>
    <div class="reset__user-details"  style="background-color:beige;">
