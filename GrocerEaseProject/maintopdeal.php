        ...
        <div class="container page__body"  style="background-color:beige;">
            ...
            <div class="section__topdeal-body">
                ...
                ?>
                    <div class="item-card">
                        ...
                        <a href="product.php?product-id=<?php echo $res['PRODUCT_ID'][$i]; ?>">
                            <div class="product-card__image"  style="background-color:beige;">
                ...
                WHERE SHOP.SHOP_ID = $shop_id";
                                ...
                                <div class="product-card__wishlist"  style="background-color:beige;">
                                    ...
                                    ?>
                                        <div class="product-card__wishlist__btn"  style="background-color:beige;">
                        ...
                        <div class="product-card__details"  style="background-color:beige;">
