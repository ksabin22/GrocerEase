...
$errCount = 0;                      //Initializes two variables $errorcount and $errCount to 0
function generateNumericOTP($n)
{
    $generator = "1683579024";       //Define the generator string
    $result = "";                    // Initialize result variable

    for ($i = 1; $i <= $n; $i++) {      // Loop to generate OTP of specified length
...
if (isset($_POST['userRegisterSubmit'])) {
    ...
    $sql = "SELECT * FROM usersoci WHERE email = '$email'";
                    ...
                    <div class="login-form__content">
                        ...
                        <div class="login-form__content__body">
                            ...
                            <div class="login-form__content__login">
                                ...
                                <input type="submit" value="Sign-Up" name="userRegisterSubmit" class="btn primary-btn form-btn login-form__content__login" name="signup" style="background-color: #6fa8dc;">
                            ...
                            <div class="login-form__content__signup flex_container">
                                <div>
                                    ...
                                    <input type="submit" value="Login" class="btn primary-btn form-btn login-form__content__login" name="signup" style="background-color: #6fa8dc;">
                                ...
                                <div>
                                    ...
                                    <input type="submit" value="Register as Trader" class="btn primary-btn form-btn login-form__content__login" name="signup" style="background-color: #6fa8dc;">
