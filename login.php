                ...
                <form method="POST" action="">
                    <div class="login-form__content">
                        ...
                        <div class="login-form__content__login">
                            <input type="submit" value="Login" name="LoginSubmit"class="btn primary-btn form-btn login-form__content__login" name="signup" style="background-color: #6fa8dc;">
                        ...
                        <div class="login-form__content__signup flex_container">
                            <div>
                                ...
                                <input type="submit" value="User Register" class="btn primary-btn form-btn login-form__content__login" name="signup" style="background-color: #6fa8dc;">
